...
**FunPay Vertex** — это бот для полной автоматизации работы на торговой площадке [FunPay](https://funpay.com/). 

Программа автоматически:
- :package: **Выдает товары** покупателям сразу после оплаты
- :arrow_up: **Поднимает ваши лоты** в топ объявлений 
- :speech_balloon: **Отвечает на сообщения** по заготовленным шаблонам
- :bell: **Отправляет уведомления** в Telegram о заказах и сообщениях
- :computer: **Управляется через Telegram** - вся панель управления в боте
- :green_circle: **Поддерживает онлайн** на FunPay 24/7

По сути, это ваш личный помощник, который работает круглосуточно, позволяя вам зарабатывать даже когда вы спите или заняты другими делами.
...
- [Что это такое?](#question-что-это-такое)
